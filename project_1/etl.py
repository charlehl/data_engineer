...
# Runs etl script to get song data from data folder and upload to database sparkifydb for song play analysis.
...
def process_log_file(cur, filepath):
    ...
    time_data = zip(df['ts'].values, t.dt.hour, t.dt.day, t.dt.week, t.dt.month, t.dt.year, t.dt.weekday)
